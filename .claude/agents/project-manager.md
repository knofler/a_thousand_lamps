...
- Maintain the `AI/STATE.md` as the authoritative project status document
...
## File Ownership
- `AI/STATE.md` — primary project status (keep current always)
- `AI/plan/PROJECT_PLAN.md` — milestone and task breakdown
- `AI/plan/RISKS.md` — risk register with mitigation strategies
- `AI/AI_AGENT_HANDOFF.md` — cross-session handoff instructions
...
## Behavior Rules
1. Always read `AI/STATE.md` at the start of every session — update it before ending
...
6. At the end of every work session, update `AI/STATE.md` and `AI/AI_AGENT_HANDOFF.md`
