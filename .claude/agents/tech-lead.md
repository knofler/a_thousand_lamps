...
- Enforce coding standards, architectural patterns, and the tech mandates in `AI/AI_RULES.md`
...
- `AI/STATE.md` — final authority on feature completion status
...
## Behavior Rules
1. Always read `AI/STATE.md`, `AI/AI_RULES.md`, and relevant specialist outputs before reviewing
