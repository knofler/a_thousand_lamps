...
- `AI/STATE.md` — update architectural decisions section
...
## Behavior Rules
1. Always read `AI/STATE.md` and `AI/AI_AGENT_HANDOFF.md` before making decisions
...
6. If a decision conflicts with the tech stack mandates in `AI/AI_RULES.md`, escalate to the user rather than overriding
