...
at runtime from the globally-installed `@knofler/ai-management` module. Find its path with
`myai root` (≈ `$(npm root -g)/@knofler/ai-management`). Read agents/skills/rules from
